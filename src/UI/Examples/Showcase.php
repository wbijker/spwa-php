...
use BrickPHP\UI\Align;
use BrickPHP\UI\Color;
use BrickPHP\UI\Cursor;
use BrickPHP\UI\Direction;
use BrickPHP\UI\FontSize;
use BrickPHP\UI\FontWeight;
use BrickPHP\UI\GridColumns;
use BrickPHP\UI\Pseudo;
use BrickPHP\UI\Shadow;
use BrickPHP\UI\Table;
use BrickPHP\UI\UI;
...
class Showcase extends Component
{
    ...
    private static function footer(): UIElement
    {
        return UI::row()
            ...
            ->rounded(Unit::roundedLg())
            ->content(
                UI::text("Built with Brick UI Framework")
