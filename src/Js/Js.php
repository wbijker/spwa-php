 ...
 *   Js::run(Js::assign(Js::obj('document', 'title'), Js::str('Brick')));
 *
...
class Js
{
    ...
    /**
     * Queue a `Brick.ready(function(){ … })` wrapper around one or more
    ...
    {
        self::$calls[] = 'Brick.ready(function(){' . implode(";".PHP_EOL , $lines) . '})';
    }
     ...
     *
     *   Js::assign(Js::obj('document', 'title'), Js::str('Brick'))
